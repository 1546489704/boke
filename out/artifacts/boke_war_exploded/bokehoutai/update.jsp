...
<body data-type="generalComponents">
                ...
                <div class="tpl-block ">
                    <div class="am-g tpl-amazeui-form">
                        <div class="am-u-sm-12 am-u-md-9">
                            <form class="am-form am-form-horizontal" action="../UserServlet" id="myform">

                                <input type="hidden" name="ac" value="update">

                                <div class="am-form-group">
                                    <label for="user-name" class="am-u-sm-3 am-form-label">序号 / Id</label>
                                    <div class="am-u-sm-9">
                                        <input type="hidden"  name="userid"  value="<%=request.getParameter("id")%>">
                                        <input type="text" disabled  id="user-id" value="<%=request.getParameter("id")%>">
                                    </div>
                                </div>
                                ...
                                <div class="am-form-group">
                                    <label for="user-email" class="am-u-sm-3 am-form-label">姓名 / Name</label>
                                    <div class="am-u-sm-9">
                                ...
                                <div class="am-form-group">
                                    <label for="user-phone" class="am-u-sm-3 am-form-label">电子邮件 / Email</label>
                                    <div class="am-u-sm-9">
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="text" id="sex" name="sex" value="<%=request.getParameter("sex")%>">
                                    </div>
                                </div>

                                <div class="am-form-group">
                                    <label for="user-weibo" class="am-u-sm-3 am-form-label">职业 / Xareer</label>
                                    <div class="am-u-sm-9">
                                        <input type="text" id="zhiye" name="zhiye" value="<%=request.getParameter("career")%>">
                                    </div>
                                </div>

                                <div class="am-form-group">
                                    <div class="am-u-sm-9 am-u-sm-push-3">
                                        <button id="update" type="submit" class="am-btn am-btn-primary">保存修改</button>
                                    </div>
                                </div>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            //验证职业
            function zhi(){
                if(zhiye.val()==""&&zhiye.val().length==0){
