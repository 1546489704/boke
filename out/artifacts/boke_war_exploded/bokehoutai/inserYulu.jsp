                        ...
                        <div class="tpl-form-body tpl-form-line">
                            <form class="am-form tpl-form-line-form">
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="text" class="am-form-field tpl-form-no-bg" id="time" placeholder="发布时间" data-am-datepicker="" readonly value=""/>
                                        <small>发布时间为必填</small>
                                    </div>
                                </div>
...
<script type="text/javascript">
    function comm(){  //提交单击事件
        ...
        window.location.href="/YujuServlet?opt=insert&type="+type+"&time="+time+"&name="+name+"&introduce="+introduce;
