...
<body style="background: url(images/0007.jpg)no-repeat;background-size: cover;">
...
<div class="logins">
    <div class="formlogin">
        <div class="formlogin-title">重置密码</div>
        <form action="UserServlet" id="myform" class="formlogin-form">
            <input type="hidden" name="ac" value="chong">
            <table class="formlogin-form-table">
                ...
                <tr>
                    <td>邮&nbsp;&nbsp;&nbsp;&nbsp;箱:</td>
                    <td><input type="text" name="email" id="email" class="form-control" placeholder="请输入密保邮箱"></td>
                </tr>
                <tr style="height: 30px"></tr>
                <tr>
                    <td>新密码:</td>
                ...
                <tr id="loginmm">
                    <td><input type="submit" class="lo" value="确认重置"></td>
