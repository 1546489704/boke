 ...
 <div class="tpl-left-nav tpl-left-nav-hover">
        ...
        <div class="tpl-content-wrapper">
            ...
            <div class="tpl-portlet-components">
                ...
                <div class="tpl-block">
               <input type="hidden" value="${tishi}" id="tishi">
                    <div class="am-g">
                        <div class="tpl-form-body tpl-form-line">
                            <form class="am-form tpl-form-line-form">
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="text" class="am-form-field tpl-form-no-bg" id="date" placeholder="发布时间" value="<%=request.getParameter("date")%>" data-am-datepicker="" readonly/>
                                        <small>发布时间为必填</small>
                                    </div>
                                </div>
                                    ...
                                    <div class="am-u-sm-9">
                                        <div class="am-form-group am-form-file">
                                            <div class="tpl-form-file-img">
                                                <img name="img" src="<%=request.getParameter("img")%>" alt="">
                                            </div>
                                        </div>
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="text" id="user-weibo" name="type" placeholder="请添加分类用点号隔开" value="<%=request.getParameter("type")%>">
                                        <div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <textarea class="" rows="10" name="text" id="user-intro" placeholder="请输入文章内容"><%=request.getParameter("introduce")%></textarea>
                                    </div>
                                </div>
...
<script>
    function update() {
        var date=$("#date").val()
        var type=$("#user-weibo").val()
        var text=$("#user-intro").val()
        var id=$("#pid").val()
        window.location.href="/PhotoServlet?date="+date+"&type="+type+"&text="+text+"&opt=update&id="+id;
    }
